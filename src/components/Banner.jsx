...
const BannerStructure = ({destImg1, destImg2, destImg3, destImg4, destLink1, destLink2, destDescription}) => {
    return (
      <>
        <div className="destinations">
          ...
          <div className="destTitle">
            ...
            <p>{destDescription}</p>
            <p className="seeMore">
              See more {<FaAngleDown className="icon" />}
            </p>
          </div>
        </div>
      </>
      ...
      <>
        <div className="destinationsSect">
          <BannerStructure
            ...
            destDescription={'dkldklsdklsdkldsdjklsdjklsdjklsdjklddjklljksdjklsdjklsdsdjklsdjklsdjkl'}
          />
        </div>
      </>
    );
